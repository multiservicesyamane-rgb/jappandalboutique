          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex">
                  <span
                    className="flex items-center gap-1 px-3 rounded-l-xl text-sm font-semibold whitespace-nowrap text-white/70"
                  ...
                  <input
                    ...
                    className="flex-1 py-3.5 rounded-r-xl text-sm text-white placeholder:text-white/25 outline-none transition-all"
